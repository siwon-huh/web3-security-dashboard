      ...
      <div className="grid gap-4 md:grid-cols-2">
        {CASE_STUDIES.map((cs) => (
          <Link
            ...
            className="group block rounded-xl border border-neutral-200 bg-white p-6 hover:border-neutral-900 hover:shadow-sm transition-all"
          >
            ...
            <div className="mt-4 flex flex-wrap gap-1.5">
              {cs.highlights.slice(0, 4).map((h) => (
                <span
                  key={h}
                  className="text-[10px] uppercase tracking-wider px-2 py-0.5 rounded border border-neutral-200 text-neutral-700 bg-neutral-50"
                >
                  {h}
                </span>
              ))}
