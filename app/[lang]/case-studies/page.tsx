            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-start gap-3 min-w-0">
                  ...
                  <img
                    src={firmLogoUrl(cs.website, 64, cs.name)}
                    alt=""
                    className="h-10 w-10 rounded-md shrink-0 object-contain border border-neutral-200 dark:border-neutral-800 bg-white"
                  />
