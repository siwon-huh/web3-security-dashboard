export const FIRM_NOTES_EN: Readonly<Record<string, string>> = {
  "Trail of Bits":
  ...
  Spearbit: "Top-tier independent researcher matching model. Boutique style.",
  Zellic:
  ...
  Certora:
    "Formal verification specialist. Proves invariants via the CVL spec language.",
  Cantina:
  ...
  Sherlock: "Hybrid of audit contest and on-chain coverage.",
  Macro: "Boutique founded by ex-Coinbase engineers.",
  Dedaub: "Static analysis strength behind the Watchdog decompiler.",
  Quantstamp: "Early DeFi audit firm. Broad portfolio.",
  Ottersec:
  ...
  "Runtime Verification":
    "Formal semantics built on the K Framework.",
  "Informal Systems":
    "Maintainer of the Apalache TLA+ model checker. De facto formal verification standard for the Cosmos and Tendermint ecosystems.",
  Veridise:
  ...
  Iosiro: "Deep Synthetix-ecosystem expertise. Based in South Africa.",
  "Composable Security":
  ...
  Softstack: "EU-based mid-tier firm.",
  "Verilog Solutions":
    "Mid-tier firm marketing formal-analysis methodology. Academic tone.",
  ...
  "Team Omega": "Newer mass-market firm.",
  DeFiMoon: "Newer DeFi-focused mass-market firm.",
  "0xGuard": "Mass-market firm focused on token issuers.",
  Rugdog: "Token screening service focused on rug detection.",
  Securr: "Newer mass-market firm.",
  Audita: "Newer mass-market firm.",
  Monethic: "Newer mass-market firm.",
  Advix: "Newer firm emphasizing AI.",
  Mosaia: "Newer mass-market firm.",
  Hakflow: "Newer mass-market firm.",
  "SCV Security": "Newer mass-market firm.",
  "0xTeam": "Newer mass-market firm.",
  BugBlow: "Newer mass-market firm.",
  SecureDApp: "India-based mass-market firm.",
  "Safe Edges": "Newer mass-market firm.",
  Perimeter: "Newer boutique.",
  "Null Return": "Newer mass-market firm.",
  ChainAudits: "Newer mass-market firm.",
  "Adevar Labs": "Newer mass-market firm.",
  "Sub 7 Security": "Newer mass-market firm.",
  TechRate: "Low-cost mass-market focused on BSC and SCAN tokens.",
  Cyberscope:
    "Combined KYC and audit service for token issuers.",
  Solidproof:
    "Germany-based low-cost firm. Fast turnaround with standardized reports.",
  Hashex: "CIS-based low-cost option. Broad token coverage.",
  "InterFi Network":
...
export function firmNoteFor(
  name: string,
  defaultNote: string,
  lang: "ko" | "en",
): string {
  if (lang === "en") return FIRM_NOTES_EN[name] ?? defaultNote;
  return defaultNote;
}
